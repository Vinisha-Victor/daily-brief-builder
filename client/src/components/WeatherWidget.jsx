...
const skeletonStyle = {
  ...
  color: 'rgba(255,255,255,0.2)', fontSize: 13, letterSpacing: '0.1em'
}

export default function WeatherWidget({ weather, loading, theme }) {
  // loading state
  if (loading && !weather) return <div style={skeletonStyle}>loading weather...</div>

  // error or not yet loaded
      ...
      <div style={{ position: 'relative', zIndex: 2, padding: 32, display: 'flex', flexDirection: 'column', flex: 1, justifyContent: 'space-between' }}>
        <div>
          ...
          <p style={{ fontSize: 14, color: 'rgba(255,255,255,0.5)', margin: 0 }}>
            {weather.state ? `${weather.state}, ` : ''}{weather.city}, {weather.country}
          </p>
        </div>
